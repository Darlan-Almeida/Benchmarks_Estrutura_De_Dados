...
/**
 * Classe principal que executa o benchmark definido na classe DequeBenchmark.
 *
 * Essa classe utiliza o JMH (Java Microbenchmarking Harness) para configurar e rodar os testes de desempenho
 * realizados pela classe DequeBenchmark e gerar resultados no formato JSON.
 */
public class MainDeque {
	...
	public static void main(String[] args) throws RunnerException {
		...
		Options opt = new OptionsBuilder().include(DequeBenchmark.class.getSimpleName()) // Define que o benchmark a ser executado é o DequeBenchmark.
				.result("dados/DequeBenchmark.json") // Define que o resultado do benchmark será salvo no arquivo DequeBenchmark.json.
